...
var books = map[string]Book{
	...
	"00000000045": Book{Title: "Cloud Native Go 2", Author: "M.-Leander Reimer 2", ISBN: "00000000045"},
}
...
func BooksHandleFunc(w http.ResponseWriter, r *http.Request) {
	...
	// http://localhost:8080/api/books  with GIT
	...
	case http.MethodPost: //POST
		...
		if created {
			...
			w.Write([]byte("Book already exist "))
		}
	default:
...
func BookHandleFunc(w http.ResponseWriter, r *http.Request) {
	...
	switch method := r.Method; method {
	// http://localhost:8080/api/books/0345391802 with GET
	case http.MethodGet: //GET BOOK
	...
	// http://localhost:8080/api/books/0345391802 with PUT
	case http.MethodPut: //UPDATE BOOK
		body, err := ioutil.ReadAll(r.Body)
		if err != nil {
			w.WriteHeader(http.StatusInternalServerError)
		}
	...
	// http://localhost:8080/api/books/0345391802 with DELETE
	case http.MethodDelete: //Delete book
		DeleteBook(isbn)
		w.WriteHeader(http.StatusOK)
	default:
		w.WriteHeader(http.StatusBadRequest)
